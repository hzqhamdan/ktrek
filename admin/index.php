    ...
    <div id="rewardModal" class="modal">
        <div class="modal-content">
            ...
            <form id="rewardForm">
                ...
                <input type="hidden" id="rewardImage"> <!-- To hold existing image path when editing -->
                <div class="form-group">
                    <label>Title*</label>
                ...
                <div class="form-group">
                    <label>Attraction*</label>
                    <select id="rewardAttraction" required>
                        <option value="">Select Attraction</option>
                    </select>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label>Image File</label>
                    <input type="file" id="rewardImageFile" accept="image/*"> <!-- New file input -->
                    <small style="color: #666; font-size: 12px;">Upload an image (JPEG, PNG, GIF, WEBP)</small>
                </div>
                <!-- Optional: Display current image if editing -->
                <div class="form-group" id="currentRewardImageContainer" style="display: none;">
                    <label>Current Image:</label>
                    <img id="currentRewardImage" src="" alt="Current Reward Image" style="max-width: 200px; max-height: 200px; display: block; margin-top: 5px;">
                </div>
