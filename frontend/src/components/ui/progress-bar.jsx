...
/**
 * Segmented progress bar (shadcn-style component folder).
 * Note: Project is JS (not TS). If you migrate to TS, rename to .tsx and add types.
 */
    ...
    <div className={cn("flex flex-col gap-6", className)}>
      <div className="flex flex-col gap-3">
        <div className="flex items-center justify-between">
          ...
          {showPercentage && (
            <span
              className="text-sm font-semibold tabular-nums tracking-tight transition-all duration-300"
              style={{
                filter:
                  hoveredSegment !== null ? "brightness(1.2)" : "brightness(1)",
              }}
            >
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  isFilled ? "bg-primary-600" : "bg-gray-200/80",
                  isHovered && isFilled &&
                    "brightness-110 shadow-[0_0_16px_rgba(225,106,2,0.35)]",
                  isHovered && !isFilled && "bg-gray-200",
                  hoveredSegment !== null && !isFilled && !isHovered &&
                    "bg-gray-200/60"
                )}
        ...
        <div className="flex flex-col gap-4">
          <input
            ...
            className="w-full h-1.5 bg-gray-200 rounded-full appearance-none cursor-pointer
              ...
              [&::-webkit-slider-thumb]:shadow-[0_0_10px_rgba(225,106,2,0.35)]
              [&::-webkit-slider-thumb]:cursor-pointer
              [&::-webkit-slider-thumb]:transition-all
              [&::-webkit-slider-thumb]:duration-300
              [&::-webkit-slider-thumb]:ease-out
              [&::-webkit-slider-thumb]:hover:scale-125
              [&::-webkit-slider-thumb]:hover:shadow-[0_0_16px_rgba(225,106,2,0.5)]
              [&::-moz-range-thumb]:w-4
              [&::-moz-range-thumb]:h-4
