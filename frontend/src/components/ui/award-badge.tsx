        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 260 54" className="w-[180px] sm:w-[260px] h-auto">
          ...
          <g style={{ mixBlendMode: "overlay" }} mask={`url(#badgeMask-${type})`}>
            <g style={{
              ...
              <polygon points="0,0 260,54 260,0 0,54" fill="hsl(358, 100%, 62%)" filter={`url(#blur-${type})`} opacity="0.5" />
            </g>
            <g style={{
              ...
              <polygon points="0,0 260,54 260,0 0,54" fill="hsl(30, 100%, 50%)" filter={`url(#blur-${type})`} opacity="0.5" />
            </g>
            <g style={{
              ...
              <polygon points="0,0 260,54 260,0 0,54" fill="hsl(60, 100%, 50%)" filter={`url(#blur-${type})`} opacity="0.5" />
            </g>
            <g style={{
              ...
              <polygon points="0,0 260,54 260,0 0,54" fill="hsl(96, 100%, 50%)" filter={`url(#blur-${type})`} opacity="0.5" />
            </g>
            <g style={{
              ...
              <polygon points="0,0 260,54 260,0 0,54" fill="hsl(233, 85%, 47%)" filter={`url(#blur-${type})`} opacity="0.5" />
            </g>
            <g style={{
              ...
              <polygon points="0,0 260,54 260,0 0,54" fill="hsl(271, 85%, 47%)" filter={`url(#blur-${type})`} opacity="0.5" />
            </g>
            <g style={{
              ...
              <polygon points="0,0 260,54 260,0 0,54" fill="hsl(300, 20%, 35%)" filter={`url(#blur-${type})`} opacity="0.5" />
            </g>
            <g style={{
              ...
              <polygon points="0,0 260,54 260,0 0,54" fill="transparent" filter={`url(#blur-${type})`} opacity="0.5" />
            </g>
            <g style={{
            ...
            <g style={{
              ...
              <polygon points="0,0 260,54 260,0 0,54" fill="white" filter={`url(#blur-${type})`} opacity="0.5" />
            </g>
          </g>
        </svg>
      </div>
