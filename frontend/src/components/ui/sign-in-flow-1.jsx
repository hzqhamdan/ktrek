// Part 1: Imports and utility components
"use client";
    ...
    <div className={cn("h-full relative w-full", containerClassName)}>
      <div className="h-full w-full">
        <DotMatrix
          ...
          }_; animation_speed_factor_${animationSpeed.toFixed(1)}_; `}
          center={["x", "y"]}
        />
      </div>
      {showGradient && (
...
const RegistrationForm = ({ email, onSubmit, onBack, error, isLoading }) => {
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="text-left">
          <input
            ...
            className="w-full backdrop-blur-[1px] text-white border border-white/10 rounded-lg py-3 px-4 focus:outline-none focus:border-white/30 bg-transparent"
            disabled={isLoading}
          />
          {formErrors.username && (
        ...
        <div className="flex w-full gap-3 pt-2">
          <motion.button
            ...
            onClick={onBack}
            disabled={isLoading}
            className="rounded-full bg-white/10 text-white border border-white/20 font-medium px-8 py-3 hover:bg-white/20 transition-colors w-[30%] disabled:opacity-50"
          ...
          <motion.button
            type="submit"
            disabled={isLoading}
            className="flex-1 rounded-full font-medium py-3 bg-white text-black border-transparent hover:bg-white/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
            transition={{ duration: 0.2 }}
          >
...
export const SignInPage = ({ className, onSuccess }) => {
  ...
  const handleCompleteRegistration = async (userData) => {
    setIsLoading(true);
    setError("");
    try {
                ...
                {step === "email" ? (
                  ...
                  >
                    ...
                    <div className="pt-4">
                      ...
                      <button
                        ...
                        className="text-sm rounded-full px-4 py-2 bg-[#3b82f6] text-white hover:bg-[#60a5fa] transition-colors"
                      >
                        Sign up
                      </button>
                    </div>
                  ...
                  >
                    ...
                    <div>
                      <motion.button
                        ...
                        disabled={isLoading}
                        className="text-white/50 hover:text-white/70 transition-colors cursor-pointer text-sm disabled:opacity-50 disabled:cursor-not-allowed"
                        whileHover={{ scale: 1.02 }}
                        transition={{ duration: 0.2 }}
                      >
                  ...
                  >
                    <div className="space-y-1">
                      ...
                      <p className="text-[1.25rem] text-[#ffffff] font-light">
                        Welcome
                      </p>
                    </div>
                    <motion.div
