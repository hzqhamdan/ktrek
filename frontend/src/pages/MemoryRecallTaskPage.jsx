...
import MemoryRecallTask from "../components/tasks/MemoryRecallTask";
...
const MemoryRecallTaskPage = () => {
  ...
  const handleComplete = (responseData) => {
    showToast(responseData.is_correct ? "Memory recall successful!" : "Task completed", "success");
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background-light">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <MemoryRecallTask task={task} onComplete={handleComplete} />
      </div>
    </div>
  );
};

export default MemoryRecallTaskPage;
