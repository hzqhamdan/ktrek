// src/pages/DirectionTaskPage.jsx
import React, { useEffect, useState } from "react";
import { useParams, useNavigate } from "react-router-dom";
import { ArrowLeft } from "lucide-react";
import { tasksAPI } from "../api/tasks";
import { rewardsAPI } from "../api/rewards";
import DirectionTask from "../components/tasks/DirectionTask";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background-light">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <DirectionTask task={task} onComplete={handleComplete} />
      </div>
    </div>
  );
};

export default DirectionTaskPage;
