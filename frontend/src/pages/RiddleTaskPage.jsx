...
const RiddleTaskPage = () => {
  ...
  const handleComplete = (responseData) => {
    showToast(responseData.is_correct ? "Riddle solved successfully!" : "Task completed", "success");
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-background-light flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 font-medium">Loading riddle...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background-light">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <RiddleTask task={task} onComplete={handleComplete} />
      </div>
    </div>
  );
};

export default RiddleTaskPage;
