...
import TimeBasedTask from "../components/tasks/TimeBasedTask";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background-light">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <TimeBasedTask task={task} onComplete={handleComplete} />
      </div>
    </div>
  );
};

export default TimeBasedTaskPage;
